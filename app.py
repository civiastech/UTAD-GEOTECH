    ...
    if session:
        with st.spinner("🔍 Running inference and processing detections..."):
            ...
            try:
                ...
                # Sort detections by confidence for consistent display of single instance
                ...
                with col2:
                    st.image(image, caption="Detected Results (Single Instance Display)", use_column_width=True)
                ...
                for det in all_detections:
                    ...
                    if class_name not in unique_faults_displayed:
                        ...
                        if feedback:
                            ...
                            st.info(f"**Score**: `{feedback['score']}` | **Severity**: `{feedback['severity']}`")
...
st.markdown("--- ")
st.markdown("🔗 Powered by YOLOv8 ONNX + Streamlit + Maintenance Intelligence")
